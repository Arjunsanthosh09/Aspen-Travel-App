...
class Kuttanad extends StatelessWidget {
  const Kuttanad({super.key});
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            Padding(
              ...
              child: Text("Kuttanad is as close as one can get to a storybook land of lush green fields and winding backwaters. From cruising in houseboats to watching farmers work below sea level and soaking in the serene village life......",style: TextStyle(
                fontSize: 13
